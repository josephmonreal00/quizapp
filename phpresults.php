...
<html>
    ...
    <body>
        ...
        <?php 
            ...
            if(isset($_POST['submit'])) {
                ...
                if(!isset($_POST['answer1']) || !isset($_POST['answer2']) || !isset($_POST['answer3']) || !isset($_POST['answer4']) || !isset($_POST['answer5']) || !isset($_POST['answer6']) || !isset($_POST['answer7']) || !isset($_POST['answer8']) || !isset($_POST['answer9']) || !isset($_POST['answer10'])) {
                    ...
                    echo "<br>";
                    echo "<a href='phpquiz.php'>Finish Quiz Please!</a>";
                }
                    ...
                    foreach($_POST as $key => $val) {
                        ...
                        $query = "INSERT INTO phpsubmitted(id, answer) VALUES ('0', '$val')";
                    ...
                    $queryForAnswers = "SELECT correctanswers FROM phpanswers";
                    $resourceIDForCAnswers = mysqli_query($databaseConnection, $queryForAnswers) or die ("Error querying the table: 'phpanswers'.");
                    
                    // Query lhtlquizsubmitted
                    $queryForSubmitted = "SELECT answer FROM phpsubmitted";
                    $resourceIDForSubmitted = mysqli_query($databaseConnection, $queryForSubmitted) or die ("Error querying the table: 'phpsubmitted'.");
                    ...
                    $deleteResults = "DELETE FROM phpsubmitted";
        ...
        <br>
        <a href="phpquiz.php">Retake Exam!</a>
        <br>
