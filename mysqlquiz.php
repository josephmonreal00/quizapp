...
<html>
    ...
    <body>
        ...
        <?php 
            ...
            $query = "SELECT id, question FROM mysqlquestions";
        
            // Communication with the MySQL database and sending a query
        
            $resourceID = mysqli_query($dbc, $query) or die ("Error querying the table: 'mysqlquestions'.");
            ...
            while($row = mysqli_fetch_array($resourceID)) {
                ...
                if($row['id'] == 1) {
                    ...
                    $querySet1 = "SELECT options FROM mysqloptions WHERE id >= 1 AND id <= 4";
                    
                    // Retrieving the resource id 
                    $resourse_ID_Set_1 = mysqli_query($dbc, $querySet1) or die("Error querying the table: 'mysqloptions'.");
        ...
        <?php
                if($row['id'] == 2) {
                    ...
                    $querySet2 = "SELECT options FROM mysqloptions WHERE id >= 5 AND id <= 8";
                    
                    // Retrieving the resource id 
                    $resourse_ID_Set_2 = mysqli_query($dbc, $querySet2) or die("Error querying the table: 'mysqloptions'.");
        ...
        <?php
                if($row['id'] == 3) {
                    ...
                    // Querying the table with the options for question 2
                    $querySet3 = "SELECT options FROM mysqloptions WHERE id >= 9 AND id <= 12";
                    
                    // Retrieving the resource id 
                    $resourse_ID_Set_3 = mysqli_query($dbc, $querySet3) or die("Error querying the table: 'mysqloptions'.");
        ...
        <?php
                if($row['id'] == 4) {
                    ...
                    // Querying the table with the options for question 2
                    $querySet4 = "SELECT options FROM mysqloptions WHERE id >= 13 AND id <= 16";
                    
                    // Retrieving the resource id 
                    $resourse_ID_Set_4 = mysqli_query($dbc, $querySet4) or die("Error querying the table: 'mysqloptions'.");
        ...
        <?php
                if($row['id'] == 5) {
                    ...
                    // Querying the table with the options for question 2
                    $querySet5 = "SELECT options FROM mysqloptions WHERE id >= 17 AND id <= 20";
                    
                    // Retrieving the resource id 
                    $resourse_ID_Set_5 = mysqli_query($dbc,$querySet5) or die("Error querying the table: 'mysqloptions'.");
        ...
        <?php
                if($row['id'] == 6) {
                    ...
                    // Querying the table with the options for question 2
                    $querySet6 = "SELECT options FROM mysqloptions WHERE id >= 21 AND id <= 24";
                    
                    // Retrieving the resource id 
                    $resourse_ID_Set_6 = mysqli_query($dbc, $querySet6) or die("Error querying the table: 'mysqloptions'.");
        ...
        <?php
                if($row['id'] == 7) {
                    ...
                    // Querying the table with the options for question 2
                    $querySet7 = "SELECT options FROM mysqloptions WHERE id >= 25 AND id <= 28";
                    
                    // Retrieving the resource id 
                    $resourse_ID_Set_7 = mysqli_query($dbc,$querySet7) or die("Error querying the table: 'mysqloptions'.");
        ...
        <?php
                if($row['id'] == 8) {
                    ...
                    // Querying the table with the options for question 2
                    $querySet8 = "SELECT options FROM mysqloptions WHERE id >= 29 AND id <= 32";
                    
                    // Retrieving the resource id 
                    $resourse_ID_Set_8 = mysqli_query($dbc,$querySet8) or die("Error querying the table: 'mysqloptions'.");
        ...
        <?php
                if($row['id'] == 9) {
                    ...
                    // Querying the table with the options for question 2
                    $querySet9 = "SELECT options FROM mysqloptions WHERE id >= 33 AND id <= 36";
                    
                    // Retrieving the resource id 
                    $resourse_ID_Set_9 = mysqli_query($dbc, $querySet9) or die("Error querying the table: 'mysqloptions'.");
        ...
        <?php
                if($row['id'] == 10) {
                    ...
                    // Querying the table with the options for question 2
                    $querySet10 = "SELECT options FROM mysqloptions WHERE id >= 37 AND id <= 40";
                    
                    // Retrieving the resource id 
                    $resourse_ID_Set_10 = mysqli_query($dbc, $querySet10) or die("Error querying the table: 'mysqloptions'.");
